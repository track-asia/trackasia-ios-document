...
struct Constants {
    ...
    static let urlStyle3DVN = "https://tiles.track-asia.com/sats/v1/satellite/satellite.json?key=public"
    static let urlStyle3DSG = "https://sg-tiles.track-asia.com/sats/v1/satellite/satellite.json?key=public"
    static let urlStyle3DTH = "https://th-tiles.track-asia.com/sats/v1/satellite/satellite.json?key=public"
}
